...
% matFiles = {'ber1.mat', 'ber2.mat', 'ber3_1.mat'};
matFiles = {'ber1.mat', 'ber2.mat', 'ber3_imsure_0.25.mat','ber3_0.75.mat','ber3_0.5.mat','ber3_0.25.mat'};
% 为每个数据集定义图例中显示的标签
legendLabels = {'方案1', '方案2', '方案3,{imsure,0.25}','方案三,{0.75}','方案三,{0.5}','方案三,{0.25}'};
