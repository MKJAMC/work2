...
%% 信道检测
% SNR_dB = 0:5:15;
% nmse_iter_per_snr=[2000,2000,2000,2000];
...
for i_snr=1:length(SNR_dB)
  ...
  %% H_eff等效信道
    ...
    if exist('nmse_iter_per_snr', 'var')
    chanel_err(i_snr) = nmse_accumulator / nmse_iter_per_snr(i_snr);
    end
